...
function loadProject(obj){
    try{
        ...
        log('Error loading assignment: ' + e, 'error');
    }
}
...
function setDefaultContent(){
    ed_html.setValue(`
        ...
        <section class="card" style="max-width: 520px; margin: 24px auto; padding: 18px; text-align: center;">
            ...
            <p>This is a simple web-based code editor that supports HTML, CSS, and JavaScript.</p>
...
function saveProject(){
    try{
        ...
        a.click();
        log('Project saved locally and downloaded');
...
log('Editor ready. Press Ctrl+Enter to run the web preview, Ctrl+S to save the project.');
